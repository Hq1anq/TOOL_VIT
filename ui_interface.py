...
################################################################################
## Form generated from reading UI file 'interfaceQIrbfy.ui'
##
...
"QPlainTextEdit:focus, QLineEdit:focus { border: 2px solid rgb(91, 101, 124) }")
        ...
        self.credits.setStyleSheet(u"font-size: 11px; color: rgb(113, 126, 149);\n"
"border: none; padding: none; padding-left: 10px; padding-right: 10px")
        icon = QIcon()
...
"border: none")
        ...
        self.gridLayout_3 = QGridLayout(self.send)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.gridLayout_3.setContentsMargins(-1, 0, -1, -1)
        self.sendLog = QPlainTextEdit(self.send)
        self.sendLog.setObjectName(u"sendLog")
        self.sendLog.setMaximumSize(QSize(16777215, 90))
        font1 = QFont()
        font1.setFamilies([u"Segoe UI"])
        font1.setBold(False)
        font1.setItalic(False)
        self.sendLog.setFont(font1)
        self.sendLog.setReadOnly(True)

        self.gridLayout_3.addWidget(self.sendLog, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.message, 2, 1, 3, 1)
        ...
        self.gridLayout_3.addWidget(self.sendOK, 5, 1, 1, 1, Qt.AlignmentFlag.AlignRight)
        ...
        self.listLink.setFont(font1)

        self.gridLayout_3.addWidget(self.listLink, 2, 0, 1, 1)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/icons/icons/ImportFromGroup.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.fromGroupCheckbox.setIcon(icon6)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.delayLabel.setText(QCoreApplication.translate("MainWindow", u"v\u00ed d\u1ee5: 3, 2, 0.5, 1.5\nDefault: 1", None))
